...
The following will give you a table with timing results using the new_conus12km
benchmark with WRFV4.0 compiled with intel18.0.1 and mpt2.18 scaled across 1, 2,
4, 8 nodes on cheyenne. (cheyenne's 36 cores/node is the default in
~wrf_run_pbs_job~)

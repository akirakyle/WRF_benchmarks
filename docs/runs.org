...
| Case          | WRF     | Compiler    | MPI     | T      | N |     Wall |  P |  M | O |
|---------------+---------+-------------+---------+--------+---+----------+----+----+---|
| new_conus12km | WRFV4.0 | intel18.0.1 | mpt2.18 | T1_p18 | 1 | 01:00:00 | 18 | 18 |   |
| new_conus12km | WRFV4.0 | intel18.0.1 | mpt2.18 | T1_p09 | 1 | 01:00:00 |  9 |  9 |   |
| new_conus12km | WRFV4.0 | intel18.0.1 | mpt2.18 | T1_p04 | 1 | 02:00:00 |  4 |  4 |   |
| new_conus12km | WRFV4.0 | intel18.0.1 | mpt2.18 | T1_p02 | 1 | 04:00:00 |  2 |  2 |   |
| new_conus12km | WRFV4.0 | intel18.0.1 | mpt2.18 | T1_p01 | 1 | 06:00:00 |  1 |  1 |   |
...
wrf_run_pbs_job -c ~/WRF_benchmarks/cases/${RUN[0]} \
      -w ~/work/WRFs/${RUN[1]}-${RUN[2]}-${RUN[3]} \
      -t ${RUN[4]} -n ${RUN[5]} -p ${RUN[7]} -m ${RUN[8]} -a ${RUN[6]} -q share
#+end_src

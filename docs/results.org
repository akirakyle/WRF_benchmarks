...
#+begin_src ipython :session
def plot_scaling(cases, labels, title, shifts=None, legend_outside=True, fmts=None):
...
#+begin_src ipython :session :ipyfile ./imgs/mvapich-io-new_conus12km.svg
case, wrf, comp, trial = 'new_conus12km', 'WRFV4.0', 'gnu8.1.0', 'T1'
...
plt.ylabel("Time")
plt.legend(loc='best')
plt.title("Scaling I/O for new_conus12km")
plt.grid(False)
#+end_src
...
:RESULTS:
# Out[59]:
[[file:./imgs/mvapich-io-new_conus12km.svg]]
:END:

#+begin_src ipython :session :ipyfile ./imgs/mvapich-io-new_conus2.5km.svg
...
plt.ylabel("Time")
plt.legend(loc='best')
plt.title("Scaling of write time for new_conus2.5km")
plt.grid(False)
#+end_src
...
:RESULTS:
# Out[60]:
[[file:./imgs/mvapich-io-new_conus2.5km.svg]]
:END:
...
#+name: new_conus12km-cases-compiler-fig
| case          | WRF version | compiler              | mpi        | trial |
|---------------+-------------+-----------------------+------------+-------|
| new_conus12km | WRFV4.0     | gnu8.1.0              | mpt2.18    | T1    |
| new_conus12km | WRFV4.0     | gnu8.1.0_O3           | mvapich2.2 | T1    |
...
| intel18.0.1 -O3                      |
| intel18.0.1 -Xhost                   |
| intel18.0.1  -xHost -fp-model fast=2 |

** figs
#+header: :var cases=new_conus12km-cases-gnu-mpi labels=new_conus12km-labels-gnu-mpi
#+header: :var title=""
#+begin_src ipython :session :ipyfile ./imgs/new_conus12km_gnu_mpi.svg
plot_scaling(cases, labels, title, legend_outside=False, fmts=['.--', 'o--', 'x--', '+--'])
#+end_src

#+RESULTS:
:RESULTS:
# Out[4]:
[[file:./imgs/new_conus12km_gnu_mpi.svg]]
:END:

#+header: :var cases=new_conus12km-cases-intel-mpi labels=new_conus12km-labels-intel-mpi
#+header: :var title=""
#+begin_src ipython :session :ipyfile ./imgs/new_conus12km_intel_mpi.svg
plot_scaling(cases, labels, title, legend_outside=False, fmts=['o--', 'x--', '.--'])
#+end_src
...
:RESULTS:
# Out[5]:
[[file:./imgs/new_conus12km_intel_mpi.svg]]
:END:

#+header: :var cases=new_conus12km-cases-compiler-fig labels=new_conus12km-labels-compiler-fig
#+header: :var title=""
#+begin_src ipython :session :ipyfile ./imgs/new_conus12km_bar_compiler_fig.svg
plot_bar(cases, 'N016.rsl', labels, title)
#+end_src
...
#+attr_latex: :width 0.8\linewidth
[[file:./figs/scalingideppresdav.png]]

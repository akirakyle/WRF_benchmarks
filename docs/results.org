...
plot_scaling(cases, labels, title, legend_outside=False, fmts=['bo', 'gx', 'r+', 'y2'])
plt.legend(frameon=False)
plt.loglog([150,3500000],[25,0.002], 'C7-', zorder=0)#, linewidth=2.0)
plt.loglog([8000,700000],[20,0.3], 'b-', zorder=0)#, linewidth=2.0)
plt.text(7500, 22, 'Yellowstone Scaling Trend', rotation=-44)
...
| new_conus12km | WRFV4.0     | gnu8.1.0_Ofast_native | mpt2.18    | T1    |
| new_conus12km | WRFV4.0     | intel18.0.1           | mpt2.18    | T1    |
| new_conus12km | WRFV4.0     | intel18.0.1_O2        | mpt2.18    | T1    |
| new_conus12km | WRFV4.0     | intel18.0.1_host      | mpt2.18    | T1    |
| new_conus12km | WRFV4.0     | intel18.0.1_opt66     | mpt2.18    | T1    |
...
plt.ylim((0.5527280832636986, 19.066819718699122))
#+end_src

#+RESULTS:
:RESULTS:
# Out[285]:
: (0.5527280832636986, 19.066819718699122)
...
ax.set_xlabel('Normalized Computational Speed', fontweight='bold')
...
:RESULTS:
# Out[326]:
: Text(0.5,0,'Normalized Computational Speed')
...
#+header: :var cases_intel=new_conus12km-cases-compiler-intel-fig
#+header: :var labels=new_conus12km-labels-compiler-fig
#+begin_src ipython :session :ipyfile ./figs/new_conus12km_bar_compiler_fig_stretch.svg
nodes='N002.rsl'
secs_gnu = []
for case in cases_gnu:
    sec = getFromDict(data, case+[nodes])[2]
...
ax.invert_yaxis()
#ax.set_xlabel('Time steps/s', fontweight='bold')
ax.set_xlabel('Normalized Computational Performance', fontweight='bold')
...
:RESULTS:
# Out[321]:
: Text(0.5,0,'Normalized Computational Performance')
